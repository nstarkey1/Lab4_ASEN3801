...
% Trim pitch angle
theta_trim_a = -atan2(25*10^-3, m*g);
phi_trim_a = 0; 



u_trim = cos(theta_trim_a) * Va_trim;
w_trim = sin(theta_trim_a) * Va_trim;
...
IC_trim_a = [0; 0; 0; phi_trim_a; theta_trim_a; 0; u_trim; 0; w_trim; 0; 0; 0];
